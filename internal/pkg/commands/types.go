...
type DockerComposeUpOptions struct {
	// Path : path to docker-compose.yaml (deprecated: use Paths for multiple files)
	Path string
	// Paths : paths to docker-compose files (e.g., base + override files). If set, takes precedence over Path
	Paths []string
...
type DockerComposePullOptions struct {
	// Path to the docker-compose.yaml (deprecated: use Paths for multiple files)
	Path string
	// Paths : paths to docker-compose files (e.g., base + override files). If set, takes precedence over Path
	Paths []string
	// Services names
